...
key = 'R36Aba067KUpWMAWbKRDO4ueS9v9tmnO'
class Blockchain:
...
def escrow(request):
    if request.method=="POST":
        sender_address="rahLnueiLidLPRNfHLX9XWiFU2oAb1H5PV"
        sender_seed="sEdTRkTAnFZWVKhfQkwtH4SNNXF4VLp"
        recipient_adress="rfuegFTmpDVTdz2teroxrh7qkWfk4wJGEA"
